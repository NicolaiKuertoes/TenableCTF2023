...
(function (_, _0x1b11ab) {
  var array = ['FFiHo', 'fQYsf', 'PSMEK', 'fHNjI2NgaA', 'log', '3333978wBY', 'fdNFC', 'paKiw', 'shift', '6nMpKMt', 'aqE', 'yyyaI', 'FnyYM', 'Srhqn', 'cqLDK', 'FlluK', 'skamI', 'mKB', 'reverse', 'Epuem', 'ehwdC', 'Not implem', 'yZQwd', '2kMQraK', '2282352jiO', 'XAodd', 'lthNi', 'Yfgkk', 'MDSIC', 'FmpvA', 'UeUNF', 'oQUxU', 'avbDa', 'RzOAR', 'GGhhk', '236046XdgO', '48517AjJpR', '2248020VDmzGa', '424erSbWD', 'LElVZ', '50VJNKtb', '4996gCHKLM', '387064uVnprw', 'Jlj', '2681065Vjg', 'TLayY', 'split', 'QisZw', '314000fQcnwx', 'ZDyDa', 'PvOKR', 'XkZxe', '3IoFoig', 'ented.', 'LtDWI', 'pepyh', '2285525hAx', 'qvVmj', '9guhgOr', 'XogTu', 'BdmMA', 'HVjXx', 'charCodeAt', 'jSHtH', 'YtPFU', 'vOOEr', 'push', 'mbDZk', '310080UgNx', '123tzQtJD', 'Zm1jZH92N2', 'tkcFVhbXs6', 'fDKaB', 'length', 'FcKRF', 'jxjuK', '2490096jpjurH', '142439ZMbchO', '7314070bHQAMC', 'FkhwG', 'XxhbU', 'WRq', 'GHSLi', 'fromCharCo', 'ATFpB', 'join', 'EZnJl', 'eylpU'];
  while (true) {
    try {
      var someNumber = 207056;
      if (someNumber === _0x1b11ab) {
        break;
      } else {
...
var _0x5114 = ["shift", "push", '', "length", "charCodeAt", "reverse", "424erSbWD", "50VJNKtb", "2285525hAxmKB", "2681065VjgJlj", "Zm1jZH92N2tkcFVhbXs6fHNjI2NgaA==", "split", "3IoFoig", "310080UgNxMY", "2282352jiOaqE", "fromCharCode", "3333978wBYWRq", "Not implemented.", "join", "236046XdgOCv", "6nMpKMt", "48517AjJpRI", "log"];
var _0x7f9546 = _0x3e24;
(function (_0x2039c6, _0x12f713) {
  var _0x35cb0d = _0x2039c6();
  while (true) {
    try {
      var _0xcf8c8d = parseInt(_0x3e24(268)) / 1 * (parseInt(_0x3e24(275)) / 2) + -parseInt(_0x3e24(269)) / 3 + parseInt(_0x3e24(270)) / 4 + -parseInt(_0x3e24(265)) / 5 * (-parseInt(_0x3e24(276)) / 6) + -parseInt(_0x3e24(277)) / 7 * (parseInt(_0x3e24(279)) / 8) + parseInt(_0x3e24(272)) / 9 + -parseInt(_0x3e24(280)) / 10 * (parseInt(_0x3e24(281)) / 11);
      if (_0xcf8c8d === _0x12f713) {
        break;
      } else {
        _0x35cb0d[_0x5114[1]](_0x35cb0d[_0x5114[0]]());
      }
    } catch (_0x1a4061) {
      _0x35cb0d[_0x5114[1]](_0x35cb0d[_0x5114[0]]());
    }
...
function getElementFromArray(p1, p2) {
  var array = ['2681065VjgJlj', 'Zm1jZH92N2tkcFVhbXs6fHNjI2NgaA==', 'split', '3IoFoig', '310080UgNxMY', '2282352jiOaqE', 'fromCharCode', '3333978wBYWRq', 'Not implemented.', 'join', '236046XdgOCv', '6nMpKMt', '48517AjJpRI', 'reverse', '424erSbWD', '50VJNKtb', '2285525hAxmKB'];
  helper = function (p1, p2) {
    p1 = p1 - 265;
    var toReturn = array[p1];
    return toReturn;
  };
  return helper(p1, p2);
}
...
function returnArray() {
  return ['FFiHo', 'fQYsf', 'PSMEK', 'fHNjI2NgaA', 'log', '3333978wBY', 'fdNFC', 'paKiw', 'shift', '6nMpKMt', 'aqE', 'yyyaI', 'FnyYM', 'Srhqn', 'cqLDK', 'FlluK', 'skamI', 'mKB', 'reverse', 'Epuem', 'ehwdC', 'Not implem', 'yZQwd', '2kMQraK', '2282352jiO', 'XAodd', 'lthNi', 'Yfgkk', 'MDSIC', 'FmpvA', 'UeUNF', 'oQUxU', 'avbDa', 'RzOAR', 'GGhhk', '236046XdgO', '48517AjJpR', '2248020VDmzGa', '424erSbWD', 'LElVZ', '50VJNKtb', '4996gCHKLM', '387064uVnprw', 'Jlj', '2681065Vjg', 'TLayY', 'split', 'QisZw', '314000fQcnwx', 'ZDyDa', 'PvOKR', 'XkZxe', '3IoFoig', 'ented.', 'LtDWI', 'pepyh', '2285525hAx', 'qvVmj', '9guhgOr', 'XogTu', 'BdmMA', 'HVjXx', 'charCodeAt', 'jSHtH', 'YtPFU', 'vOOEr', 'push', 'mbDZk', '310080UgNx', '123tzQtJD', 'Zm1jZH92N2', 'tkcFVhbXs6', 'fDKaB', 'length', 'FcKRF', 'jxjuK', '2490096jpjurH', '142439ZMbchO', '7314070bHQAMC', 'FkhwG', 'XxhbU', 'WRq', 'GHSLi', 'fromCharCo', 'ATFpB', 'join', 'EZnJl', 'eylpU'];
}
function validateFlag(_0x1dd864) {
  var _0x4269fd = 'Not implemented.';
  return _0x4269fd === 'Not implemented.';
}
function reverseFlag(flag) {
  return flag.split('').reverse().join('');
}
function encryptFlag(flag) {
  var toReturn = '';
  for (var i = 0; i < flag.length; i++) {
    var char = flag.charCodeAt(i);
    var xoredChar = char ^ i;
    toReturn += String.fromCharCode(xoredChar);
  };
  return btoa(toReturn);
}
...
function _0x2a8b() {
  return ['2681065VjgJlj', 'Zm1jZH92N2tkcFVhbXs6fHNjI2NgaA==', 'split', '3IoFoig', '310080UgNxMY', '2282352jiOaqE', 'fromCharCode', '3333978wBYWRq', 'Not implemented.', 'join', '236046XdgOCv', '6nMpKMt', '48517AjJpRI', 'reverse', '424erSbWD', '50VJNKtb', '2285525hAxmKB'];
}
console.log(flag);
```

Code uses the following function to encrypt flag:
```js
function encryptFlag(flag) {
  var toReturn = '';
  for (var i = 0; i < flag.length; i++) {
...
```js
function decryptFlag(encryptedFlag) {
  var encryptedFlag = atob(encryptedFlag);
  var flag = '';
  for (var i = 0; i < encryptedFlag.length; i++) {
    var char = encryptedFlag.charCodeAt(i);
    var xoredChar = char ^ i;
    flag += String.fromCharCode(xoredChar);
  }
  return flag
}
```
...
Output:
```
decryptFlag("Zm1jZH92N2tkcFVhbXs6fHNjI2NgaA==")
